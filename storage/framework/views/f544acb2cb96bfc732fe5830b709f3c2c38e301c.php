...
<div id="vue">
    <div class="container">
        <suplementos :p_kits="<?php echo e($kits); ?>"></suplementos>
    </div>
</div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div v-for="(kits, tipo) in suplementos" :class="'tab-pane fade '+activarTab(tipo) " :id="tipo.substring(0,1)" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <span>Etapa {{ parseInt(tipo[2])+1 }}</span> 
    ...
    Vue.component('suplementos',{
        ...
        methods: {
            ...
            save: function () {
                ...
                vm.guardando = true;
                vm.errors = [];
                axios.post('<?php echo e(url('/suplementos/save')); ?>', {suplementos: vm.suplementos, eliminados:vm.elimSuplementos})
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/configuracion/suplementos.blade.php ENDPATH**/ ?>