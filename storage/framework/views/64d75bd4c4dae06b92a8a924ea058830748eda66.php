...
<?php $__env->startSection('content'); ?>
    <div id="vue">
        <div class="container">
            <contactos :medios="<?php echo e($medios); ?>"></contactos>
        </div>
    </div>
        ...
        <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <paginador ref="paginador" :url="'<?php echo e(url('configuracion/contactos/buscar')); ?>'" @loaded="loaded"></paginador>
                </div>
            </div>
        ...
        Vue.component('contactos', {
            ...
            methods: {
                ...
                getMensaje: function (contacto) {
                    let vm = this;
                    vm.buscando = true;
                    axios.get('<?php echo e(url('configuracion/contactos/getMensaje/')); ?>/'+contacto.id).then(function (response) {
                ...
                quitarContacto: function (id) {
                    let vm = this;
                    axios.post('<?php echo e(url('configuracion/contactos/quitar')); ?>', this.contacto).then(function (response) {
                        vm.$refs.eliminarModal.closeModal();
                        vm.buscar();
                    });
                },
                exportar: function () {
                    window.open('<?php echo e(url('/configuracion/contactos/exportar')); ?>/'+JSON.stringify(this.filtros),'_blank');
                },
                enviarCorreos: function () {
                    let vm = this;
                    axios.post('<?php echo e(url('configuracion/contactos/enviarCorreos')); ?>').then(function (response) {
                    });
                }
            },
            mounted:function () {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/configuracion/contactos.blade.php ENDPATH**/ ?>