    ...
    <div id="vue">
        <div class="container">
            <div class="row justify-content-center">
                <inicio :p_videos="<?php echo e($videos); ?>" :p_categorias="<?php echo e($categorias); ?>"
                        :p_pendientes="<?php echo e($pendientes); ?>"></inicio>
            </div>
        </div>
    </div>
                    ...
                    <div class="d-flex flex-wrap">
                        <div v-for="(v, index) in p_videos" class="col-sm-4">
                            ...
                            <video :id="'v'+index" width="320" height="240" controls :src="v.src"
                                   poster="<?php echo e(asset('/img/poster.png')); ?>" preload="none" controls="auto">
                        ...
                        <div v-for="(categoria, index) in categorias">
                            ...
                            <div class="d-flex flex-wrap" v-if="categoria.mostrar">
                                <div v-for="ejercicio in categoria.ejercicios" class="ejercicio" align="center">
                                    ...
                                    <br>
                                    <video :src="'<?php echo e(url('configuracion/ejercicio/')); ?>/'+categoria.nombre+'/'+ejercicio"
                                           width="240" height="120"
                                           poster="<?php echo e(asset('/img/poster.png')); ?>" preload="none" controls="auto">
                                        <source :src="'<?php echo e(url('configuracion/ejercicio/')); ?>/'+ejercicio"
                                                type="video/mp4">
                                    </video>
                                </div>
                            </div>
        ...
        Vue.component('inicio', {
            ...
            methods: {
                ...
                subirCategoria: function(categoria){
                    let vm = this;
                    axios.post("<?php echo e(url('/configuracion/categoria')); ?>", categoria).then(function (respuesta) {
                        vm.loading = false;
                ...
                subirEjercicios: function (event, categoria) {
                    ...
                    if (size >= 320.0) {
                        ...
                        axios.post("<?php echo e(url('/configuracion/ejercicio')); ?>", formData).then(function (respuesta) {
                            vm.loading = false;
                ...
                subirVideo: function (event, nombre) {
                    ...
                    if (fileSize <= 320.0) {
                        ...
                        axios.post('<?php echo e(url('configuracion/video')); ?>', fm).then(function (response) {
                ...
                quitarEjercicio: function (categoria, ejercicio) {
                    let vm = this;
                    vm.loading = true;
                    axios.post('<?php echo e(url('configuracion/quitarEjercicio')); ?>', {
                ...
                getEjercicios: function (categoria) {
                    let vm = this;
                    vm.buscando = true;
                    axios.get('<?php echo e(url('configuracion/getEjerciciosCategoria/')); ?>/' + categoria.nombre).then(function (response) {
                ...
                getVideosPendientes: function () {
                    let vm = this;
                    vm.buscando = true;
                    axios.get('<?php echo e(url('configuracion/getVideosPendientes')); ?>').then(function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/configuracion/videos.blade.php ENDPATH**/ ?>