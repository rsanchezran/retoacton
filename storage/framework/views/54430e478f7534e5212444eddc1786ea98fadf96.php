...
<?php $__env->startSection('content'); ?>
    ...
    <div id="vue">
        <div class="container">
            <dias :p_dias="<?php echo e($dias); ?>" :p_semana="<?php echo e($semana); ?>" :maximo="<?php echo e($maximo); ?>" :teoricos="<?php echo e($teoricos); ?>"></dias>
        </div>
    </div>
        ...
        Vue.component('dias', {
            ...
            methods: {
                ...
                getDia: function (dia) {
                    let vm = this;
                    vm.buscando = true;
                    axios.get('<?php echo e(url('/reto/getDia/')); ?>/' + dia).then(function (response) {
                ...
                mostrarSemana: function (semana) {
                    let vm = this;
                    axios.get('<?php echo e(url('/reto/getSemanaCliente/')); ?>/' + semana).then(function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/reto/cliente.blade.php ENDPATH**/ ?>