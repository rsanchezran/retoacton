...
<?php $__env->startSection('content'); ?>
    <div id="vue">
        <programa :p_dias="<?php echo e($dias); ?>" :p_semana="<?php echo e($semana); ?>" :maximo="<?php echo e($maximo); ?>" :teorico="<?php echo e($teorico); ?>"></programa>
    </div>
        ...
        Vue.component('programa', {
            ...
            methods: {
                configurar: function (dia, genero, objetivo) {
                    window.location.href = '<?php echo e(url('configuracion/dia')); ?>/' + dia + '/' + genero + '/' + objetivo;
                },
                mostrarSemana: function (semana) {
                    let vm = this;
                    axios.get('<?php echo e(url('/configuracion/programa/getSemanaEjercicios/')); ?>/' + semana).then(function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/configuracion/programa.blade.php ENDPATH**/ ?>