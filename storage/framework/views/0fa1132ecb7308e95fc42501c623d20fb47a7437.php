...
<?php $__env->startSection('content'); ?>
    <div id="pago" class="container flex-center">
        <contacto class="pt-5" :p_contacto="<?php echo e($contacto); ?>"></contacto>
    </div>
    ...
    <template id="contacto-template">
        <div class="container">
            ...
            <div class="d-flex flex-column">
                <div>
                    <captcha ref="captcha" sitekey="<?php echo e(env('CAPTCHA_PUBLIC')); ?>" @verify="onVerify" :loadRecaptchaScript="true">
                    </captcha>
        ...
        Vue.component('contacto', {
            ...
            methods: {
                enviar: function () {
                    let vm = this;
                    vm.loading = true;
                    axios.post('<?php echo e(url('dudas')); ?>', this.contacto).then(function () {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/auth/dudas.blade.php ENDPATH**/ ?>