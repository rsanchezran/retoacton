...
<head>
    ...
    <script src="<?php echo e(asset('js/bootstrap-datepicker.es.js')); ?>"></script>
    <!-- Fonts -->
    ...
    <link href="<?php echo e(asset('css/breathing.css')); ?>" rel="stylesheet" type="text/css" />
    <style>
        @font-face {
            font-family: unitext;
        ...
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                <?php if(auth()->guard()->guest()): ?>
                    <img src="<?php echo e(asset('img/postergris.png')); ?>"  style="z-index: 2; position: absolute; top: 5px;">
                <?php else: ?>
                    <img src="<?php echo e(asset('img/postergris.png')); ?>">
                <?php endif; ?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(\Illuminate\Support\Facades\Auth::user()->rol==\App\Code\RolUsuario::CLIENTE): ?>
                            <?php if(\Illuminate\Support\Facades\Auth::user()->tarjeta==''): ?>
                                <a class="nav-link tarjeta" href="<?php echo e(url('cuenta')); ?>" title="Es necesario que registres una tarjeta para depositarte tus comisiones">
                                    <i class="fas fa-user text-danger"></i> Mi cuenta
                                </a>
                            <?php else: ?>
                                <a class="nav-link" href="<?php echo e(url('cuenta')); ?>">
                        ...
                        <?php endif; ?>
                        <?php if(\Illuminate\Support\Facades\Auth::user()->rol==\App\Code\RolUsuario::CLIENTE): ?>
                            <?php if(\Illuminate\Support\Facades\Auth::user()->inicio_reto!=null): ?>
                                <a class="nav-link" href="<?php echo e(url('/reto/cliente')); ?>"><i class="far fa-running"></i> Actividades</a>
                            <?php endif; ?>
                            <a class="nav-link" href="<?php echo e(url('/reto/programa')); ?>">
                                <i class="far fa-calendar-alt"></i> Programa</a>
                        <?php else: ?>
                            <a class="nav-link" href="<?php echo e(url('/reto/configuracion')); ?>">
                                <i class="far fa-running"></i> Actividades</a>
                        <?php endif; ?>
                        <?php if(\Illuminate\Support\Facades\Auth::user()!=null && \Illuminate\Support\Facades\Auth::user()->vencido): ?>
                        ...
                        <?php endif; ?>
                        <?php if(\Illuminate\Support\Facades\Auth::user()->rol==\App\Code\RolUsuario::ADMIN): ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-lab elledby="administracion">
                                    <a class="dropdown-item" href="<?php echo e(url('/configuracion/videos')); ?>">
                                        <i class="far fa-video"></i> Videos</a>
                                    <a class="dropdown-item" href="<?php echo e(url('/configuracion/programa')); ?>">
                                        <i class="far fa-calendar-alt"></i> Programa</a>
                                    <a class="dropdown-item" href="<?php echo e(url('/suplementos/')); ?>">
                                        <i class="far fa-prescription-bottle"></i> Suplementos </a>
                                    <a class="dropdown-item" href="<?php echo e(url('/configuracion/contactos')); ?>">
                                        <i class="far fa-users"></i> Contactos</a>
                                    <a class="dropdown-item" href="<?php echo e(url('/usuarios/')); ?>">
                        ...
                        <?php if(\Illuminate\Support\Facades\Auth::user()->rol==\App\Code\RolUsuario::ADMIN): ?>
                            ...
                            <div class="dropdown-menu" aria-lab elledby="administracion">
                                <a class="dropdown-item" href="<?php echo e(url('/encuesta')); ?>">
                                    <i class="far fa-poll-h"></i> Encuesta</a>
                                <a class="dropdown-item" href="<?php echo e(url('/reto/dia/1/0/0')); ?>">
                                    <i class="far fa-clipboard-list"></i> Dieta 1</a>
                                <a class="dropdown-item" href="<?php echo e(url('/reto/dia/15/0/0')); ?>">
                                    <i class="far fa-clipboard-list"></i> Dieta 2</a>
                                <a class="dropdown-item" href="<?php echo e(url('/reto/dia/29/0/0')); ?>">
                                    <i class="far fa-clipboard-list"></i> Dieta 3</a>
                                <a class="dropdown-item" href="<?php echo e(url('/reto/dia/43/0/0')); ?>">
                ...
                <ul class="navbar-nav ml-auto">
                    <?php if(auth()->guard()->guest()): ?>
                        <li class="nav-item">
                            <a style="color: #1d68a7" class="nav-link" href="<?php echo e(route('login')); ?>">Miembros</a>
                        </li>
                        <li class="nav-item">
                            <a style="color: #1d68a7" class="nav-link" href="<?php echo e(route('register')); ?>">Registro</a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php if(\Illuminate\Support\Facades\Auth::user()!=null&&\Illuminate\Support\Facades\Auth::user()->rol==\App\Code\RolUsuario::CLIENTE &&
                        ...
                        <video controls poster="<?php echo e(asset('/img/poster.png')); ?>">
                            <source src="<?php echo e(url('/getVideo/termino').'/'.rand(1,100)); ?>" type="video/mp4">
                        </video>
                    <?php endif; ?>
                </div>
            </div>
