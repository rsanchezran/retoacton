...
<?php $__env->startSection('content'); ?>
    <div id="vue">
        <div class="container">
            <programa :p_dia="<?php echo e($dia); ?>" :usuario="<?php echo e($usuario); ?>" :configuraciones="<?php echo e($configuraciones); ?>"
                      :genero="'<?php echo e($genero); ?>'" :objetivo="'<?php echo e($objetivo); ?>'"></programa>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="<?php echo e(url('/configuracion/programa/')); ?>" class="btn btn-sm btn-light">
                ...
                <div class="d-flex flex-wrap">
                    <div v-for="(ejercicio, iejercicio) in serie.ejercicios" class="ejercicio col-sm-5">
                        <div class="video d-flex">
                            ...
                            <video poster="<?php echo e(asset('img/poster.png')); ?>" v-else class="embed-responsive-item" preload="none" controls="auto"
                                   :src="'<?php echo e(url('configuracion/ejercicio/')); ?>/'+ejercicio.video">
                                <source :src="'<?php echo e(url('configuracion/ejercicio/')); ?>/'+ejercicio.video"
                                        type="video/mp4">
                            </video>
                            <div class="d-flex flex-column float-right">
            ...
            methods: {
                agregarCardio: function () {
                    this.dia.cardio.push({
                        ...
                        ejercicio: '',
                        video: '',
                        tipo: '<?php echo e(\App\Code\TipoEjercicio::AEROBICO); ?>',
                ...
                guardar: function () {
                    ...
                    this.loading = true;
                    this.errors = {};
                    axios.post('<?php echo e(url('configuracion/dia')); ?>', this.dia).then(function (response) {
                ...
                copiarConfiguracion: function () {
                    ...
                    if (respuesta) {
                        ...
                        axios.get("<?php echo e(url('configuracion/getDia/')); ?>/" + conf[0] + "/" + conf[1] + "/" + conf[2]).then(function (response) {
        ...
        Vue.component('repo-explorer', {
            ...
            methods: {
                buscar: function () {
                    ...
                    axios.post('<?php echo e(url('configuracion/ejercicios')); ?>', {nombre: this.nombre}).then(function (response) {
            ...
            methods: {
                buildEjercicio: function () {
                    return {
                        ...
                        ejercicio: '',
                        video: '',
                        tipo: '<?php echo e(\App\Code\TipoEjercicio::ANAEROBICO); ?>',
                        subseries: [],
                        genero: this.genero,
                        objetivo: this.objetivo,
                        lugar: this.modo=='gym'?'<?php echo e(\App\Code\LugarEjercicio::GYM); ?>':'<?php echo e(\App\Code\LugarEjercicio::CASA); ?>'
                    };
                },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/configuracion/dia.blade.php ENDPATH**/ ?>