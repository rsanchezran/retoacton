...
<?php $__env->startSection('content'); ?>
    <div id="vue" class="container flex-center">
        <inicio :usuario="<?php echo e($usuario); ?>" :referencias="<?php echo e($referencias); ?>" :monto="<?php echo e($monto); ?>" :descuento="<?php echo e($descuento); ?>"
        :original="<?php echo e($original); ?>"></inicio>
    </div>

    <template id="inicio-template">
        <div class="container">
            <?php if(\Illuminate\Support\Facades\Auth::user()->vencido): ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <cobro ref="cobro" :cobro="''+monto" :url="'<?php echo e(url('/')); ?>'" :id="'<?php echo e(env('OPENPAY_ID')); ?>'"
                               :llave="'<?php echo e(env('OPENPAY_PUBLIC')); ?>'" :sandbox="'<?php echo e(env('SANDBOX')); ?>'==true" :meses="true"
                ...
                <div class="card-body" style="padding: 0">
                    ...
                    <div style="display: flex; flex-wrap:wrap;  background-color: #E9E9E9; padding: 20px">
                        <div class="col-12 col-sm-6" align="center" style="border:padding: 5px">
                            <img :src="'<?php echo e(url('cuenta/getFotografia/'.\Illuminate\Support\Facades\Auth::user()->id.'/'.rand(0,10))); ?>'"
                                 width="100">
                            <h4>Código personal</h4>
                            <h4 class="acton"><?php echo e(\Illuminate\Support\Facades\Auth::user()->referencia); ?></h4>
                        </div>
                        <div class="col-12 col-sm-6 d-flex" style="align-items: flex-end;">
                            <div class="d-block ml-auto mr-auto text-center">
                                ...
                                <a v-if="usuario.inicio_reto==null" class="btn btn-lg btn-primary" href="<?php echo e(url('/reto/comenzar/')); ?>">
                                    <span>EMPEZAR RETO</span>
                                </a>
                                <a v-else class="btn btn-lg btn-primary" href="<?php echo e(url('/reto/programa')); ?>">
                                    <span>Mi programa</span>
                                </a>
                                <br>
                                <br>
                                <a href="<?php echo e(asset('/assets/cuaderno.pdf')); ?>" target="_blank">
                    ...
                    <div class="dash">
                        <div class="table-responsive">
                            ...
                            <div class="float-right">
                                <paginador ref="paginador" :url="'<?php echo e(url('/usuarios/referencias')); ?>'" @loaded="loaded"></paginador>
                                <br>
                            </div>
                        </div>
                    </div>
        ...
        Vue.component('inicio', {
            ...
            methods: {
                ...
                verPagos: function (referencia) {
                    ...
                    axios.get('<?php echo e(url('/verPagos/')); ?>/'+referencia.id).then(function (response) {
