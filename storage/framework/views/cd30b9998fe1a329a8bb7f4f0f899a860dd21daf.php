...
<?php $__env->startSection('content'); ?>
    <div id="pago" class="container flex-center">
        <contacto class="pt-5" :p_contacto="<?php echo e($contacto); ?>" :objetivos="<?php echo e($objetivos); ?>"></contacto>
    </div>
    ...
    <template id="contacto-template">
        <div class="container">
            <div id="header" align="center">
                ...
                <h6 class="text-uppercase font-weight-bold" style="color: #013451; font-size: 2em">Acton de <?php echo e((int)(env('DIAS')/7)); ?> semanas</h6>
            </div>
            <div>
            ...
            <div class="d-flex flex-column">
                <div>
                    <captcha ref="captcha" sitekey="<?php echo e(env('CAPTCHA_PUBLIC')); ?>" @verify="onVerify">
                    </captcha>
        ...
        Vue.component('contacto', {
            ...
            methods: {
                enviar: function () {
                    let vm = this;
                    vm.loading = true;
                    axios.post('<?php echo e(url('contacto')); ?>', this.contacto).then(function () {
...
<?php echo $__env->make('layouts.welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/auth/contacto.blade.php ENDPATH**/ ?>