...
@section('content')
    ...
    <template id="videos-template">
        ...
        <div>
            ...
            <a href="https://suplementos.retoacton.com/" class="btn btn-primary btn-lg col-md-6 offset-md-3 col-sm-6 offset-sm-3" style="color: white; background: #fb9b04; font-size: 35px;border-radius: 10px; font-weight: bolder;height: 80px;padding-top: 13px; font-family: unitext_bold_cursive;">Ver suplementos</a>
            <br>
            <br>
