                    ...
                    @forelse ($users as $u)
                        <tr>
                            ...
                            <td>
                                ...
                                <button v-tooltip="{content:'Eliminar usuario'}" class="btn btn-sm btn-danger" @click="confirmar({{$u}})">
        ...
        Vue.component('contactos', {
            ...
            methods: {
                ...
                PagarTienda: function (usuario) {
                    ...
                    vm.referencia = '';
                    vm.loading = true;
                    axios.get('{{url('configuracion/pagar-coach')}}/' + usuario).then(function (response) {
                ...
                saveContactoTienda: function () {
                    ...
                    if (Object.keys(this.errors).length == 0) {
                        axios.post("{{url("configuracion/saveContactoCoach")}}", this.informacion).then(function (response) {
                            vm.sent = true;
                            vm.loading = false;
