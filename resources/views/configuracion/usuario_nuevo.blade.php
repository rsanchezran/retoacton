        ...
        Vue.component('contactos', {
            ...
            methods: {
                ...
                saveContacto: function () {
                    ...
                    this.informacion.codigo = 1;
                    this.informacion.dias = this.informacion.dias;
                    ...
                    if (Object.keys(this.errors).length == 0) {
                        axios.post("{{url("configuracion/saveContactoUsuarioNuevo")}}", this.informacion).then(function (response) {
                            vm.sent = true;
                            vm.loading = false;
