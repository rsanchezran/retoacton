...
@section('content')
    <div class="container">
        ...
        <ul>
            <li>1. Estos términos y condiciones ("Términos y Condiciones") rigen y determinan este sitio web y / o sus aplicaciones
            ...
            <li>4. Al visitar este sitio web, usted otorga debidamente su total consentimiento para estar sujeto a los Términos y
                Condiciones del Sitio y a todas las demás condiciones, en relación con, y que surjan de y por su uso.
                Su consentimiento se considera otorgado mediante el uso del Sitio, su categoría de menú o subcategoría, sección o subsección,
                así como por el surgimiento, desarrollo y terminación de cualquier relación legal que surja de y por el uso de este sitio web.</li>
            <li>5. Al visitar este sitio web, usted otorga su pleno consentimiento para la recopilación y el uso de su información personal para
                el uso del sitio y todas las relaciones que surjan o estén relacionadas con el sitio.
                Al registrarse y utilizar el Sitio, está obligado tanto a la configuración actual del sitio web, como a todos los cambios
                realizados en forma de adiciones y cambios o desarrollo de nuevos menús, categorías, secciones y otros.
        ...
        <h3>Servicio</h3>
        <ul>
            <li>14. El servicio ofrecido por el sitio Reto Acton genera una dieta individual. Este último es producido por un software
                especial a través de un algoritmo creado especialmente según las respuestas de los clientes que se analizan y se genera un
                modo de alimentación y / o capacitación.</li>
            <li>15. El costo se describe por completo y se fija en el sitio, ya que el mismo es pagadero antes de otorgar la dieta individual
                en la forma expresamente establecida en el sitio.</li>
        </ul>
        ...
        <h3>Marca</h3>
        <ul>
            <li>20. Las marcas comerciales, logotipos, nombres comerciales (empresas) que se muestranen el Sitio o están disponibles a través del Sitio, están registrados por los derechos de autor y están protegidos por la ley.</li>
            <li>21. Está prohibido usar lo anterior en cualquier producto y / o servicio que no esté relacionado y / o patrocinado por los titulares de los derechos de la marca / logotipo.</li>
            <li>22. Está prohibido usar lo anterior de una manera que pueda engañar a los consumidores sobre la naturaleza y calidad de los servicios. Se prohíben todas las acciones a través de las cuales de alguna manera degradar o desacreditar a los titulares que surjan del registro.</li>
        </ul>
    </div>
