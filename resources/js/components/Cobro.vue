...
<template>
    <div class="d-flex flex-wrap col-12 col-sm-6 d-block mr-auto ml-auto">
        <div class="col-12 col-sm-5 formaPago" @click="metodoPago('openpay')">
        ...
        <div class="col-12 col-sm-5 formaPago">
            <h6>La forma rápida de pagar</h6>
            <br>
            <div id="paypalDiv"></div>
        </div>
        <div class="col-12 col-sm-5 formaPago" @click="metodoPago('spei')">
            <h6>Pago con SPEI</h6>
            <br>
            <img :src="url+'/img/spei.png'" width="80">
        </div>
        <div class="col-12 col-sm-5 formaPago" @click="metodoPago('oxxo')">
            <h6>Pago en Oxxo</h6>
            <br>
            <img :src="url+'/img/oxxopay.png'" width="150">
        </div>
        <div class="col-12 col-sm-6" v-if="response.referencia!=''">
        ...
        <modal ref="openpay" title="Pago con tarjeta" @ok="openpay()" :high="'500'" :btncerrar="true" :showok="acuerdo">
            <div style="background-color: #f6f6f6; color: #0b2e13">
                ...
                <p class="text-center">La cantidad a cobrar será de <money :cantidad="cobro"></money></p>
