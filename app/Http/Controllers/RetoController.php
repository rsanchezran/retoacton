...
class RetoController extends Controller
{
    ...
    public function dia(Request $request, $dia, $genero, $objetivo)
    {
        ...
        if(intval($diasTranscurridos) > intval($user->dias)){
            $diasTranscurridos = intval($user->dias);
        }
        ...
        if ($usuarioDieta == null) {
            ...
            $diaDB = Dia::buildDia($dia, $genero, $objetivo, $request->user(), $numDietas, $numSemanaSuplementacion);
