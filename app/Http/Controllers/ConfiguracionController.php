    ...
    public function saveDia(Request $request)
    {
        ...
        $this->validate($request,
            [
                ...
                'gym.*.ejercicios.*.subseries.*.repeticiones' => 'numeric|max:99|min:1',
                'casa.*.ejercicios.*.subseries.*.repeticiones' => 'numeric|max:99|min:1',
            ...
            [
                ...
                'gym.*.ejercicios.*.subseries.*.repeticiones.numeric' => 'Esta repeticion debe ser numerica',
                'gym.*.ejercicios.*.subseries.*.repeticiones.max' => 'Esta repeticion debe ser maximo 99',
                'gym.*.ejercicios.*.subseries.*.repeticiones.min' => 'Esta repeticion debe ser minimo 1',
                'casa.*.ejercicios.*.subseries.*.repeticiones.numeric' => 'Esta repeticion debe ser numerica',
                'casa.*.ejercicios.*.subseries.*.repeticiones.max' => 'Esta repeticion debe ser maximo 99',
                'casa.*.ejercicios.*.subseries.*.repeticiones.min' => 'Esta repeticion debe ser minimo 1',
